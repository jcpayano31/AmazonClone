...
function Payment() {
    ...
    const handleChange = event => {
        ...
        // and display any errors as the customer types ther crd details
        setDisable(event.empty);
        setError(event.error ? EvalError.error.message: "");
    ...
    return (
      <div className="payment">
        <div className="payment__container">
          ...
          <div className="payment__section">
            <div className="payment__title">
              <h3>Reriew items and delivery</h3>
            </div>
          ...
          {/* Payament section - Payment method */}
          <div className="payment__section">
            <div className="payment__title">
